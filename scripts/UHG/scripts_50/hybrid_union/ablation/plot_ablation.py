...
For each dataset this reads:
  alpha=0.3: results_50/ablation/<dataset>/uhg/alpha_0.3.txt (UHG)
             results_50/main/<dataset>/uhg/alpha_0.3.txt     (UHGS via auto)
  alpha=0.7: results_50/ablation/<dataset>/uhg/alpha_0.7.txt (UHG)
             results_50/main/<dataset>/uhg/alpha_0.7.txt     (UHGH via auto)
"""
...
ABLATION_ROOT = REPO_ROOT / "scripts" / "UHG" / "results_50" / "ablation"
MAIN_ROOT = REPO_ROOT / "scripts" / "UHG" / "results_50" / "main"

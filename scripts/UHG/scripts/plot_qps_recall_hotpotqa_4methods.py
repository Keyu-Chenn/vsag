...
DEFAULT_RESULT_DIR = Path("/tbase-project/vsag/scripts/UHG/results/hotpotqa_4methods")
DEFAULT_OUTPUT_PREFIX = DEFAULT_RESULT_DIR / "recall_qps_hotpotqa_4methods"
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Plot Recall@100-QPS curves for HotpotQA 4-method results."
    )
    parser.add_argument(
        "--result-dir",
        type=Path,

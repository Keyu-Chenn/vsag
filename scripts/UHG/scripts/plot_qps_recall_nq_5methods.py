...
DEFAULT_BASE_RESULT_DIR = Path("/tbase-project/vsag/scripts/UHG/results/nq_4methods")
DEFAULT_UHGH_RESULT_DIR = Path("/tbase-project/vsag/scripts/UHG/results/nq_uhgh")
DEFAULT_OUTPUT_PREFIX = Path("/tbase-project/vsag/scripts/UHG/results/nq_5methods/recall_qps_nq_5methods")
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Plot Recall@100-QPS curves for NQ 4-method results plus UHGH."
    )
    parser.add_argument(
        "--base-result-dir",
        type=Path,
        ...
        help=(
            "Directory containing existing nq_4methods alpha_*.txt files. "

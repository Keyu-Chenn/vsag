...
For each dataset this reads:
  alpha=0.3: results_20/ablation/<dataset>/uhg/alpha_0.3.txt (UHG)
             results_20/main/<dataset>/uhg/alpha_0.3.txt     (UHGS via auto)
  alpha=0.7: results_20/ablation/<dataset>/uhg/alpha_0.7.txt (UHG)
             results_20/main/<dataset>/uhg/alpha_0.7.txt     (UHGH via auto)
"""
...
ABLATION_ROOT = REPO_ROOT / "scripts" / "UHG" / "results_20" / "ablation"
MAIN_ROOT = REPO_ROOT / "scripts" / "UHG" / "results_20" / "main"
